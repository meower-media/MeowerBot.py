    ...
    def on_close(self, ws, close_status_code, close_msg):
        ...
        if self.on_close in self.cloudlink.usercallbacks:
            if self.cloudlink.usercallbacks[self.on_close] != None:
                self.cloudlink.usercallbacks[self.on_close](
                    ...
                    if (message["cmd"] in self.cloudlink.builtInCommands) and not (
                        ...
                        if self.on_packet in self.cloudlink.usercallbacks:
                            if self.cloudlink.usercallbacks[self.on_packet] != None:
                                self.cloudlink.usercallbacks[self.on_packet](
                                    message=message
                                )
                    else:
                        ...
                        if isValid:
                            if isLegacy:
                                ...
                                getattr(self.cloudlink, str(message["val"]["cmd"]))(
                                    message=message
                                )
                            else:
                                if isCustom:
                                    ...
                                    getattr(self.cloudlink, str(message["cmd"]))(
                                        message=message
                                    )
                                else:
