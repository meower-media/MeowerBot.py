...
class client:
    ...
    async def sendDirect(
        self, message: any, username: str = None, listener: str = None
    ):
        if self.ws_client.open:
    ...
    async def sendCustom(
        self, cmd: str, message: any, username: str = None, listener: str = None
    ):
        if self.ws_client.open:
    ...
    async def sendPing(
        self, dummy_payload: any = "", username: str = None, listener: str = None
    ):
        if self.ws_client.open:
    ...
    async def sendPrivateMessage(
        self, message: any, username: str = "", listener: str = None
    ):
        if self.ws_client.open:
    ...
    async def sendGlobalVariable(
        self, var_name: str, var_value: any, listener: str = None
    ):
        if self.ws_client.open:
    ...
    async def sendPrivateVariable(
        self, var_name: str, var_value: any, username: str = "", listener: str = None
    ):
        if self.ws_client.open:
    ...
    async def __run__(self, ip):
        ...
        async with self.wss.connect(ip) as websocket:
            ...
            try:
                ...
                await self.clientRootHandlers.on_close(
